...
class SparkClusterConfig:
    ...
    Attributes:
        worker_count (Union[Unset, int]): Number of worker nodes in the Spark cluster (Range: 1 to 25). Default: 4.
        ...
        worker_memory (Union[Unset, int, str]): Memory allocated per worker node (Range: 102.4 MiB to 256 GiB). Accepts
            formats like '10GiB', '10240MiB'. Default: '50GiB'.
        master_cores (Union[Unset, int]): Number of CPU cores allocated to the master node (Range: 1 to 64). Default: 1.
        master_memory (Union[Unset, int, str]): Memory allocated for the master node (Range: 102.4 MiB to 256 GiB).
            Accepts formats like '10GiB', '10240MiB'. Default: '50GiB'.
    """

    worker_count: Union[Unset, int] = 4
    worker_cores: Union[Unset, int] = 1
    worker_memory: Union[Unset, int, str] = "50GiB"
    master_cores: Union[Unset, int] = 1
    master_memory: Union[Unset, int, str] = "50GiB"
